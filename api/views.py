...
def tryOutRequest(inputForm, restrictionEnzymes, context):
    ...
    context["expectPolyMorph"] = int(inputForm.cleaned_data["tryOutExpectPolyMorph"])/POLYMORPHISM_MODIFIER if inputForm.cleaned_data["tryOutExpectPolyMorph"] != "" else None
...
def checkCorrectSequenceCalculationFields(inputForm):
    ...
    if (inputForm.cleaned_data['formMode'] == 'tryOut'):
        ...
        if (inputForm.cleaned_data["tryOutExpectPolyMorph"] == "" and inputForm.cleaned_data["coverage"] == "" and inputForm.cleaned_data["basepairLengthToBeSequenced"] == "" and inputForm.cleaned_data["sequencingYield"] == ""):
            raise Exception("Please insert a an 'Expected SNP density', 'Read length to be sequenced', a 'Sequencing Yield' and a 'Desired depth'")
        ...
        if (inputForm.cleaned_data["tryOutExpectPolyMorph"] == "" and inputForm.cleaned_data["basepairLengthToBeSequenced"] == "" and inputForm.cleaned_data["sequencingYield"] == "" and inputForm.cleaned_data["coverage"] != ""):
            raise Exception("Please insert an 'Expected SNP density', a 'Sequencing Yield' and a 'Read length to be sequenced'")

        if (inputForm.cleaned_data["tryOutExpectPolyMorph"] == "" and inputForm.cleaned_data["basepairLengthToBeSequenced"] == "" and inputForm.cleaned_data["sequencingYield"] != "" and inputForm.cleaned_data["coverage"] == ""):
            raise Exception("Please insert an 'Expected SNP density', a 'Read length to be sequenced' and a 'Desired depth'")

        if (inputForm.cleaned_data["tryOutExpectPolyMorph"] == "" and inputForm.cleaned_data["basepairLengthToBeSequenced"] != "" and inputForm.cleaned_data["sequencingYield"] == "" and inputForm.cleaned_data["coverage"] == ""):
            raise Exception("Please insert an 'Expected SNP density', a 'Sequencing Yield' and a 'Desired depth'")

        if (inputForm.cleaned_data["tryOutExpectPolyMorph"] == "" and inputForm.cleaned_data["basepairLengthToBeSequenced"] != "" and inputForm.cleaned_data["sequencingYield"] != "" and inputForm.cleaned_data["coverage"] == ""):
            raise Exception("Please insert an 'Expected SNP density' and a 'Desired depth'")

        if (inputForm.cleaned_data["tryOutExpectPolyMorph"] == "" and inputForm.cleaned_data["basepairLengthToBeSequenced"] == "" and inputForm.cleaned_data["sequencingYield"] != "" and inputForm.cleaned_data["coverage"] != ""):
            raise Exception("Please insert an 'Expected SNP density' and a 'Read length to be sequenced'")

        if (inputForm.cleaned_data["tryOutExpectPolyMorph"] == "" and inputForm.cleaned_data["basepairLengthToBeSequenced"] != "" and inputForm.cleaned_data["sequencingYield"] == "" and inputForm.cleaned_data["coverage"] != ""):
            raise Exception("Please insert an 'Expected SNP density' and a 'Sequencing Yield'")
